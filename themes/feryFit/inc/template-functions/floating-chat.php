					...
					<?php if (!empty($options['whatsapp'])) : ?>
						<li class="feryfit-drawer-option">
							<a href="<?php echo esc_url($options['whatsapp']); ?>" target="_blank" class="feryfit-drawer-link">
								...
								<span class="feryfit-drawer-text">Chat on WhatsApp</span>
					...
					<?php if (!empty($options['email'])) : ?>
						<li class="feryfit-drawer-option">
							<a href="<?php echo esc_url($options['email']); ?>" class="feryfit-drawer-link">
								...
								<span class="feryfit-drawer-text">Send an Email</span>
								<span class="feryfit-drawer-arrow">
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
										<path d="M9.5 6L15.5 12L9.5 18" stroke="#B8B8B8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
									</svg>
					...
					<?php if (!empty($options['facebook'])) : ?>
						<li class="feryfit-drawer-option">
							<a href="<?php echo esc_url($options['facebook']); ?>" target="_blank" class="feryfit-drawer-link">
								...
								<span class="feryfit-drawer-text">Message us on Facebook</span>
								<span class="feryfit-drawer-arrow">
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
										<path d="M9.5 6L15.5 12L9.5 18" stroke="#B8B8B8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
									</svg>
				...
				<?php if (!empty($options['whatsapp'])) : ?>
					<li class="feryfit-chat-option">
						<a href="<?php echo esc_url($options['whatsapp']); ?>" target="_blank" class="feryfit-chat-link">
							...
							<span class="feryfit-chat-text">Chat on WhatsApp</span>
				...
				<?php if (!empty($options['email'])) : ?>
					<li class="feryfit-chat-option">
						<a href="<?php echo esc_url($options['email']); ?>" class="feryfit-chat-link">
							...
							<span class="feryfit-chat-text">Send an Email</span>
							<span class="feryfit-chat-arrow">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
									<path d="M9.5 6L15.5 12L9.5 18" stroke="#B8B8B8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
								</svg>
				...
				<?php if (!empty($options['facebook'])) : ?>
					<li class="feryfit-chat-option">
						<a href="<?php echo esc_url($options['facebook']); ?>" target="_blank" class="feryfit-chat-link">
							...
							<span class="feryfit-chat-text">Message us on Facebook</span>
							<span class="feryfit-chat-arrow">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
									<path d="M9.5 6L15.5 12L9.5 18" stroke="#B8B8B8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
								</svg>
