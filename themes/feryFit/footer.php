...
<footer id="colophon" class="site-footer">
    <div class="footer-content">
        <div class="footer-section footer-brand">
            ...
            <p class="footer-tagline">
                <?php echo get_theme_mod('footer_tagline', 'Smart Tech Meets Everyday Life.'); ?>
            </p>
        </div>

        <div class="footer-section footer-menu">
            <button class="accordion-button" aria-expanded="false">
                <h4 class="footer-section-title"><?php echo get_theme_mod('footer_title_product', 'Product'); ?></h4>
        ...
        <div class="footer-section footer-menu">
            <button class="accordion-button" aria-expanded="false">
                <h4 class="footer-section-title"><?php echo get_theme_mod('footer_title_about', 'About & Support'); ?></h4>
                <span class="accordion-arrow">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <polyline points="6 9 12 15 18 9"></polyline>
                    </svg>
        ...
        <div class="footer-section footer-menu">
            <button class="accordion-button" aria-expanded="false">
                <h4 class="footer-section-title"><?php echo get_theme_mod('footer_title_policy', 'Policy'); ?></h4>
                <span class="accordion-arrow">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <polyline points="6 9 12 15 18 9"></polyline>
                    </svg>
        ...
        <div class="footer-section footer-contact">
            <button class="accordion-button" aria-expanded="true">
                <h4 class="footer-section-title"><?php echo get_theme_mod('footer_title_contact', 'Contact us'); ?></h4>
                <span class="accordion-arrow">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <polyline points="6 9 12 15 18 9"></polyline>
                    </svg>
            ...
            <div class="accordion-content">
                <ul class="footer-contact-list">
                    ...
                    <li class="footer-contact-item">
                        ...
                        <a href="<?php echo esc_url(get_theme_mod('footer_contact_1_url', 'mailto:service@runstar.com')); ?>" class="footer-contact-link">
                            <span class="footer-contact-label">Customer service:</span>
                            <span class="footer-contact-value">service@runstar.com</span>
                        </a>
                    </li>
                    ...
                    <li class="footer-contact-item">
                        ...
                        <a href="<?php echo esc_url(get_theme_mod('footer_contact_2_url', '#')); ?>" class="footer-contact-link">
                    ...
                    <li class="footer-contact-item">
                        ...
                        <a href="<?php echo esc_url(get_theme_mod('footer_contact_3_url', '#')); ?>" class="footer-contact-link">
    ...
    <div class="footer-bottom">
        <p class="footer-copyright">
            <?php echo get_theme_mod('footer_copyright', '&copy; ' . date('Y') . ' VeryfitVip.Store.'); ?>
        </p>
    </div>
</footer><!-- #colophon -->
